				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<form action="<?= base_url('Instrument/edit_proses')?>" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="name">Nama</label>
										<input type="text" class="form-control" id="name" name="name" value="<?= $instrument->name?>" required>
										<input type="text" class="form-control" id="id" name="id" value="<?= $instrument->id?>" hidden>
									</div>
									<div class="form-group col-md-6">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<select class="form-control" name="type" id="type">
											...
											<option value="<?= $type->lookup_name ?>" <?= ($type->lookup_name == $instrument->type) ? 'selected' : '';?>> <?= $type->lookup_name ?></option>
											<?php } ?>
										</select>
									</div>
