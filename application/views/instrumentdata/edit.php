...
<html lang="en">
	...
	<body onload=getDataTempKoefisien()>
		<div class="loader-bg">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h5>Edit Instrument</h5>
							</div>
							
							<div class="card-body">
								
							<form action="<?= base_url('InstrumentData/edit_proses')?>" method="post">
							...
							<div class="row">
									<div class="form-group col-md-4">
										...
										<?php foreach($region as $rg){?>
											<option value="<?= $rg->id ?>" <?= ($rg->id == $detail['instrument']->ms_regions_id) ? 'selected' : '';?>><?= $rg->site_name ?></option>
											<?php } ?>
										</select>
									</div>
									<div class="form-group col-md-4">
										<label class="form-label" for="kode_instrument">Kode Instrument</label>
										<input type="text" class="form-control" id="kode_instrument" name="kode_instrument" required value="<?=$detail['instrument']->kode_instrument ?>">
									</div>
									<div class="form-group col-md-4">
										<label class="form-label" for="nama_instrument">Nama Instrument</label>
										<input type="text" class="form-control" id="nama_instrument" name="nama_instrument" value="<?=$detail['instrument']->nama_instrument ?>" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-4">
										<label class="form-label" for="tr_instrument_type_id">Type Instrument</label>
										<select class="form-control" name="tr_instrument_type_id" id="tr_instrument_type_id" required>
										<option>--Pilih Type Instrument--</option>
										<?php foreach($detail['type'] as $type){?>
											<option value="<?= $type->id ?>" <?= ($type->id == $detail['instrument']->tr_instrument_type_id) ? 'selected' : '';?>><?= $type->name ?></option>
										<?php } ?>
										</select>
									</div>
									<div class="form-group col-md-4">
										<label class="form-label" for="ms_stasiun_id">Station</label>
										<select class="form-control" name="ms_stasiun_id" id="ms_stasiun_id" required>
										<option value=''>--Pilih Station--</option>
										<?php foreach($detail['station'] as $station){?>
											<option value="<?= $station->id ?>" <?= ($station->id == $detail['instrument']->ms_stasiun_id) ? 'selected' : '';?>><?= $station->nama_stasiun ?></option>
										<?php } ?>
										</select>
									</div>
									<div class="form-group col-md-4">
										<label class="form-label" for="tahun_pembuatan">Tahun Pembuatan</label>
										<input type="text" class="form-control" id="tahun_pembuatan" name="tahun_pembuatan" value="<?=$detail['instrument']->tahun_pembuatan ?>" required>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="nama_sensor" name="nama_sensor" value="<?=$detail['sensor']->nama_sensor ?>" required>
									</div>
									<div class="form-group col-md-6">
										<label class="form-label" for="serial_number">Serial Number</label>
										<input type="text" class="form-control" id="serial_number" name="serial_number" value="<?=$detail['sensor']->serial_number ?>" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="range">Range</label>
										<input type="text" class="form-control" id="range" name="range" value="<?=$detail['sensor']->range ?>" required>
									</div>
									<div class="form-group col-md-6">
										<label class="form-label" for="type">Output</label>
										<input type="text" class="form-control" id="output" name="output" value="<?=$detail['sensor']->output ?>" required>
									</div>
								</div>
									...
									<div class="row">
										<div class="form-group col-md-6">
											...
											<select class="form-control" name="zona_pemasangan" id="zona_pemasangan">
												<option value="Pondasi" <?= ($detail['instalasi']->zona_pemasangan=='Pondasi') ? 'selected' : '' ?>>Pondasi</option>
												<option value="Timbunan" <?= ($detail['instalasi']->zona_pemasangan=='Timbunan') ? 'selected' : '' ?>>Timbunan</option>
											</select>
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="tanggal_rekalibrasi">Tanggal Rekalibrasi</label>
											<input type="date" class="form-control" id="tanggal_rekalibrasi" name="tanggal_rekalibrasi" value="<?=$detail['instalasi']->tanggal_rekalibrasi?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="tanggal_instalasi">Tanggal Instalasi</label>
											<input type="date" class="form-control" id="tanggal_instalasi" name="tanggal_instalasi" value="<?=$detail['instalasi']->tanggal_instalasi?>">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="tanggal_zero_reading">Tanggal Zero Reading</label>
											<input type="date" class="form-control" id="tanggal_zero_reading" name="tanggal_zero_reading" value="<?=$detail['instalasi']->tanggal_zero_reading?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_puncak">Elevasi Puncak</label>
											<input type="number" class="form-control" id="elevasi_puncak" name="elevasi_puncak" value="<?=$detail['instalasi']->elevasi_puncak?>">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="elevasi_permukaan_saat_ini">Elevasi Permukaan Saat Ini</label>
											<input type="number" class="form-control" id="elevasi_permukaan_saat_ini" name="elevasi_permukaan_saat_ini" value="<?=$detail['instalasi']->elevasi_permukaan_saat_ini?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_sensor">Elevasi Sensor</label>
											<input type="number" class="form-control" id="elevasi_sensor" name="elevasi_sensor" value="<?=$detail['instalasi']->elevasi_sensor?>">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="elevasi_ground_water_level">Elevasi Ground Water Level</label>
											<input type="number" class="form-control" id="elevasi_ground_water_level" name="elevasi_ground_water_level" value="<?=$detail['instalasi']->elevasi_ground_water_level?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="kedalaman_sensor">Kedalaman Sensor</label>
											<input type="number" class="form-control" id="kedalaman_sensor" name="kedalaman_sensor" value="<?=$detail['instalasi']->kedalaman_sensor?>">
										</div>
									</div>
							...
							<div class="modal-body" id="formBodyCreate">
								<div class="row">
									<div class="form-group col-md-6">
										...
										<select class="form-control" name="modal_type" id="modal_type_create" onchange="getNameType(this, 'create');">
										<option value="" selected>--Pilih Instrument Type--</option>
										<?php foreach($typeinstrument as $tp){?>
		...
		<script>
			function getNameType(sel, action){
				...
				$.ajax({
					...
					method : "POST",
					data : {tr_instrument_type_id:idtype, action:action},
					beforeSend:function(){
					},
					success: function(data){
						var json = data,
