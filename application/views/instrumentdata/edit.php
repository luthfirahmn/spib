							...
							<form action="<?= base_url('InstrumentData/edit_proses') ?>" method="post">
								...
								<div class="row">
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" id="longitude" name="longitude" placeholder="Masukan Longitude atau Koordinate X" value="<?= number_format($detail['instrument']->longitude, 6) ?>" <?= ($detail['instrument']->type == 'NON_VWP') ? 'readonly' : '' ?>>
									</div>
									<div class="form-group col-md-4">
										<label class="form-label" for="latitude">Latitude</label>
										<input type="text" class="form-control" id="latitude" name="latitude" placeholder="Masukan Longitude atau Koordinate Y" value="<?= number_format($detail['instrument']->latitude, 6) ?>" <?= ($detail['instrument']->type == 'NON_VWP') ? 'readonly' : '' ?>>
									</div>
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="nama_sensor" name="nama_sensor" value="<?= $detail['sensor']->nama_sensor ?>">
									</div>
									<div class="form-group col-md-6">
										<label class="form-label" for="serial_number">Serial Number</label>
										<input type="text" class="form-control" id="serial_number" name="serial_number" value="<?= $detail['sensor']->serial_number ?>">
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="range">Range</label>
										<input type="text" class="form-control" id="range" name="range" value="<?= $detail['sensor']->range ?>">
									</div>
									<div class="form-group col-md-6">
										<label class="form-label" for="type">Output</label>
										<input type="text" class="form-control" id="output" name="output" value="<?= $detail['sensor']->output ?>">
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" name="zona_pemasangan" id="zona_pemasangan">
												<option value="Pondasi" <?= (isset($detail['instalasi']->zona_pemasangan) ? ($detail['instalasi']->zona_pemasangan == 'Pondasi') ? 'selected' : '' : '') ?>>Pondasi</option>
												<option value="Timbunan" <?= (isset($detail['instalasi']->zona_pemasangan) ? ($detail['instalasi']->zona_pemasangan == 'Timbunan') ? 'selected' : '' : '') ?>>Timbunan</option>
											</select>
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="tanggal_rekalibrasi">Tanggal Rekalibrasi</label>
											<input type="date" class="form-control" id="tanggal_rekalibrasi" name="tanggal_rekalibrasi" value="<?= isset($detail['instalasi']->tanggal_rekalibrasi) ? $detail['instalasi']->tanggal_rekalibrasi : "" ?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label class="form-label" for="tanggal_instalasi">Tanggal Instalasi</label>
											<input type="date" class="form-control" id="tanggal_instalasi" name="tanggal_instalasi" value="<?= isset($detail['instalasi']->tanggal_instalasi) ? $detail['instalasi']->tanggal_instalasi : "" ?>">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="tanggal_zero_reading">Tanggal Zero Reading</label>
											<input type="date" class="form-control" id="tanggal_zero_reading" name="tanggal_zero_reading" value="<?= isset($detail['instalasi']->tanggal_zero_reading) ? $detail['instalasi']->tanggal_zero_reading : "" ?>">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
