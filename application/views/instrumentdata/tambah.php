								...
								<div id="form_vwp" style="display: none;">
									...
									<div class="row">
										...
										<label class="form-label" for="elevasi_puncak">Elevasi Puncak</label>
											<input type="number" class="form-control" id="elevasi_puncak" name="elevasi_puncak">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="elevasi_permukaan_saat_ini">Elevasi Permukaan Saat Ini</label>
											<input type="number" class="form-control" id="elevasi_permukaan_saat_ini" name="elevasi_permukaan_saat_ini">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_sensor">Elevasi Sensor</label>
											<input type="number" class="form-control" id="elevasi_sensor" name="elevasi_sensor">
										</div>
										<div class="form-group col-md-6">
											<label class="form-label" for="elevasi_ground_water_level">Elevasi Ground Water Level</label>
											<input type="number" class="form-control" id="elevasi_ground_water_level" name="elevasi_ground_water_level">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
										<label class="form-label" for="kedalaman_sensor">Kedalaman Sensor</label>
											<input type="number" class="form-control" id="kedalaman_sensor" name="kedalaman_sensor">
										</div>
									</div>
