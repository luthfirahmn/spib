...
<html lang="en">
	...
	<head>
		<title>Form Elements | Berry Bootstrap 5 Admin Template</title>
		<meta charset="utf-8" />
	...
	<body>
								...
								<div class="row">
									...
									<form action="<?= base_url('Region/tambah_proses')?>" method="post" enctype="multipart/form-data">
											...
											<div class="row mb-3">
												...
												<div class="col-sm-9">
													<input type="number" class="form-control" id="database_port" name="database_port" required/>
												</div>
											</div>
											<div class="row mb-3">
		...
		<script>
			...
			function cek(){
				var how = confirm("Apakah Anda yakin?");
				if (how == true) {
			...
			$('#test_koneksi').click(function () {
				...
				$.ajax({
					...
					method : "POST",
					data : {database_name: database_name, database_host:database_host, database_port:database_port, database_username:database_username, database_password:database_password},
					beforeSend:function(){
