							...
							<form action="<?= base_url('Site/add_proses') ?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="number" step=".001" class="form-control" id="elev_tanggul_utama" name="elev_tanggul_utama" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elev_tanggul_pembantu" class="form-label">Elevasi Tanggul Pembantu</label>
										<input type="number" step=".001" class="form-control" id="elev_tanggul_pembantu" name="elev_tanggul_pembantu" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elev_pelimpah">Elevasi Pelimpah</label>
										<input type="number" step=".001" class="form-control" id="elev_pelimpah" name="elev_pelimpah" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elev_pelimpah_pembantu" class="form-label">Elevasi Pelimpah Pembantu</label>
										<input type="number" step=".001" class="form-control" id="elev_pelimpah_pembantu" name="elev_pelimpah_pembantu" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elev_normal">Elevasi Normal</label>
										<input type="number" step=".001" class="form-control" id="elev_normal" name="elev_normal" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elev_siaga1" class="form-label">Elevasi Siaga 1</label>
										<input type="number" step=".001" class="form-control" id="elev_siaga1" name="elev_siaga1" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elev_siaga2">Elevasi Siaga 2</label>
										<input type="number" step=".001" class="form-control" id="elev_siaga2" name="elev_siaga2" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elev_siaga3" class="form-label">Elevasi Siaga 3</label>
										<input type="number" step=".001" class="form-control" id="elev_siaga3" name="elev_siaga3" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="batas_kritis_vwp">Batas kritis VWP</label>
										<input type="number" step=".001" class="form-control" id="batas_kritis_vwp" name="batas_kritis_vwp" required>
									</div>
								</div>
