							...
							<form action="<?= base_url('Site/add_proses') ?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="number" step=".001" class="form-control" id="elevasi_puncak" name="elevasi_puncak" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elevasi_spillway" class="form-label">Elevasi Spillway</label>
										<input type="number" step=".001" class="form-control" id="elevasi_spillway" name="elevasi_spillway" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_normal">Elevasi Normal</label>
										<input type="number" step=".001" class="form-control" id="elevasi_normal" name="elevasi_normal" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elevasi_waspada" class="form-label">Elevasi Waspada</label>
										<input type="number" step=".001" class="form-control" id="elevasi_waspada" name="elevasi_waspada" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_siaga">Elevasi Siaga</label>
										<input type="number" step=".001" class="form-control" id="elevasi_siaga" name="elevasi_siaga" required>
									</div>
									<div class="form-group col-md-6">
										<label for="elevasi_awas" class="form-label">Elevasi Awas</label>
										<input type="number" step=".001" class="form-control" id="elevasi_awas" name="elevasi_awas" required>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-6">
										<label class="form-label" for="elevasi_batas_kritis">Elevasi Batas Kritis</label>
										<input type="number" step=".001" class="form-control" id="elevasi_batas_kritis" name="elevasi_batas_kritis" required>
									</div>
								</div>
